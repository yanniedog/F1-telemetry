-- F1 Historical Dataset - Complete SQLite Schema
-- Covers all data from 1950 to present
-- Includes telemetry, timing, weather, incidents, and metadata
...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    has_sector_times BOOLEAN DEFAULT 0,
    has_weather BOOLEAN DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS sector_times (
    sector_time_id INTEGER PRIMARY KEY,
    race_id INTEGER NOT NULL,
    session_id INTEGER,
    driver_id INTEGER NOT NULL,
    lap INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS safety_car_periods (
    sc_period_id INTEGER PRIMARY KEY,
    race_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS virtual_safety_car_periods (
    vsc_period_id INTEGER PRIMARY KEY,
    race_id INTEGER NOT NULL,
    period_number INTEGER NOT NULL,
    start_lap INTEGER,
    end_lap INTEGER,
...
CREATE TABLE IF NOT EXISTS drs_zones (
    drs_zone_id INTEGER PRIMARY KEY,
    circuit_id INTEGER NOT NULL,
    year INTEGER NOT NULL,
...
CREATE VIEW IF NOT EXISTS v_driver_stats AS
SELECT 
    d.driver_id,
    d.full_name,
    d.nationality,
